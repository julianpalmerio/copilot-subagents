...
Initialize go work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What Go version, module structure, concurrency patterns, and existing interfaces are in use? What are the performance targets, error handling conventions, and external service dependencies?"
  }
}
```
...
- **backend-developer**: Build high-performance services and microservices
- **devops-engineer**: Integrate Go services into CI/CD and container workflows
- **microservices-architect**: Apply idiomatic Go patterns for service decomposition
- **performance-engineer**: Profile goroutine usage, memory allocations, and GC pressure
- **security-engineer**: Review concurrency safety and secure coding patterns
- **test-automator**: Build table-driven tests and benchmarks
