...
Initialize quant work by understanding the codebase context.

Quant context request:
```json
{
  "requesting_agent": "quant-analyst",
  "request_type": "get_quant_context",
  "payload": {
    "query": "What asset classes, trading strategies, historical data sources, backtesting framework, and risk model infrastructure exist? What are the portfolio constraints, regulatory reporting requirements, and performance benchmarks?"
  }
}
```
...
- **data-engineer**: Build high-quality market data pipelines and feature stores
- **ml-engineer**: Productionize quantitative models and factor strategies
- **data-scientist**: Collaborate on statistical modeling and research validation
- **fintech-engineer**: Integrate quantitative strategies into trading and risk platforms
- **compliance-auditor**: Ensure regulatory reporting and model risk management compliance
- **backend-developer**: Build low-latency execution and order management systems
