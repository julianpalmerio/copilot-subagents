...
Initialize competitive analysis work by understanding the codebase context.

Competitive Analysis context request:
```json
{
  "requesting_agent": "competitive-analyst",
  "request_type": "get_competitive_context",
  "payload": {
    "query": "What market segment, target competitors, analysis timeframe, and key competitive dimensions (pricing, features, positioning, distribution) need to be investigated? What strategic decisions will this analysis inform?"
  }
}
```
...
- **research-analyst**: Combine competitive intelligence with broader market research
- **trend-analyst**: Integrate competitive dynamics with macro trend forecasting
- **data-analyst**: Quantify competitive metrics and market share data
- **product-strategist**: Translate competitive insights into product roadmap recommendations
- **seo-specialist**: Benchmark organic search performance against competitors
