...
Initialize database work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What database engines and versions are running, what is the schema complexity and data volume, what indexing and replication strategies exist, and what are the query performance SLAs?"
  }
}
```
...
- **backend-developer**: Optimize ORM usage, query patterns, and schema design
- **cloud-architect**: Select managed database services and HA configurations
- **devops-engineer**: Automate database provisioning, migrations, and backups
- **security-engineer**: Implement encryption at rest/transit and access controls
- **data-engineer**: Design schemas supporting efficient ETL and analytical queries
- **performance-engineer**: Profile query execution plans and index effectiveness
