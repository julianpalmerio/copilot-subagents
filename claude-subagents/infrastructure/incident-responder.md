...
Initialize incident work by understanding the codebase context.

Incident context request:
```json
{
  "requesting_agent": "incident-responder",
  "request_type": "get_incident_context",
  "payload": {
    "query": "What observability stack (metrics, logs, traces), alerting rules, runbooks, and on-call rotation currently exist? What is the current incident severity classification and escalation process?"
  }
}
```
...
- **sre-engineer**: Align incident workflows with SLO breach response procedures
- **devops-engineer**: Use deployment and infrastructure tools during remediation
- **security-engineer**: Escalate and coordinate on security incident response
- **database-administrator**: Support database recovery and integrity verification
- **cloud-architect**: Assess infrastructure changes needed for incident mitigation
- **platform-engineer**: Access internal tooling for service restoration and rollbacks
