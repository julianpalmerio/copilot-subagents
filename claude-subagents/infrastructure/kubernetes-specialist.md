...
Initialize kubernetes work by understanding the codebase context.

Kubernetes context request:
```json
{
  "requesting_agent": "kubernetes-specialist",
  "request_type": "get_kubernetes_context",
  "payload": {
    "query": "What is the cluster topology, Kubernetes version, CNI/CSI plugins, workload types, resource quotas, and existing Helm/Kustomize configuration? What are the SLA and scaling requirements?"
  }
}
```
...
- **devops-engineer**: Integrate cluster management into CI/CD delivery workflows
- **cloud-architect**: Align cluster architecture with cloud-native design patterns
- **security-engineer**: Implement pod security policies, RBAC, and network policies
- **sre-engineer**: Define HPA/KEDA scaling and SLO-based alerting
- **terraform-engineer**: Provision cluster infrastructure and managed node groups
- **docker-expert**: Optimize container images for Kubernetes runtime efficiency
- **platform-engineer**: Build developer self-service on top of Kubernetes primitives
