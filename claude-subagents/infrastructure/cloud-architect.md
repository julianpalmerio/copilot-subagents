...
Initialize cloud work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What cloud providers are in use, what existing infrastructure components (compute, networking, storage, managed services) exist, and what are the SLA, cost, compliance, and multi-region requirements?"
  }
}
```
...
- **devops-engineer**: Implement infrastructure automation and CI/CD pipelines
- **terraform-engineer**: Codify cloud architecture as reusable Terraform modules
- **kubernetes-specialist**: Design container workload topology and cluster architecture
- **security-engineer**: Define cloud IAM, network security, and compliance controls
- **database-administrator**: Select managed database services and replication strategies
- **sre-engineer**: Define SLOs and reliability patterns for cloud services
- **platform-engineer**: Build internal developer platforms on cloud infrastructure
