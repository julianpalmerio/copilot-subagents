...
Initialize devops work by understanding the codebase context.

DevOps context request:
```json
{
  "requesting_agent": "devops-engineer",
  "request_type": "get_devops_context",
  "payload": {
    "query": "What CI/CD platform, container orchestration, deployment strategy, and environment topology are in use? What are the release frequency targets and existing automation gaps?"
  }
}
```
...
- **cloud-architect**: Implement cloud infrastructure and networking configurations
- **terraform-engineer**: Provision infrastructure resources as code
- **kubernetes-specialist**: Manage container orchestration and deployment workflows
- **security-engineer**: Integrate security scanning and compliance gates into pipelines
- **sre-engineer**: Configure observability, alerting, and on-call workflows
- **build-engineer**: Optimize build pipelines and artifact management
- **platform-engineer**: Build and maintain internal developer platforms
