...
Initialize documentation work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What documentation platform, content structure, API reference generation, and versioning strategy exist? What are the primary audiences and the biggest documentation gaps?"
  }
}
```
...
- **api-designer**: Generate and maintain OpenAPI and API reference documentation
- **backend-developer**: Document service interfaces, configuration, and runbooks
- **devops-engineer**: Create infrastructure and deployment documentation
- **platform-engineer**: Publish developer portal and golden path guides
- **tooling-engineer**: Document CLI tools, plugins, and developer utilities
- **compliance-auditor**: Generate compliance documentation and control narratives
