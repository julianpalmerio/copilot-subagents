...
Initialize git work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What Git branching strategy, merge/rebase policies, commit conventions, branch protection rules, and release process exist? What are the team size and release cadence constraints?"
  }
}
```
...
- **devops-engineer**: Integrate branching strategy with CI/CD pipeline triggers
- **build-engineer**: Align branch policies with build and test automation workflows
- **platform-engineer**: Configure repository templates and organization-wide branch policies
- **code-reviewer**: Establish PR review workflows, required reviewers, and merge policies
- **release-manager**: Define release branching and tagging conventions
- **documentation-engineer**: Document Git conventions and onboarding guides
