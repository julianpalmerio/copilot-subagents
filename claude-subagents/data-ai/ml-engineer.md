...
Initialize ml work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What ML training infrastructure, model registry, serving platform, and monitoring setup exist? What are the model types, training frequency, and production SLAs for inference latency and accuracy?"
  }
}
```
...
- **data-scientist**: Productionize research models with engineering rigor
- **mlops-engineer**: Integrate models into automated training and deployment pipelines
- **data-engineer**: Consume feature stores and training dataset pipelines
- **ai-engineer**: Serve ML models within AI-powered application architectures
- **devops-engineer**: Deploy GPU-enabled inference infrastructure
- **performance-engineer**: Optimize model serving latency and throughput
