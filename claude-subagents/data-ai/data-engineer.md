...
Initialize data engineering work by understanding the codebase context.

Data Engineering context request:
```json
{
  "requesting_agent": "data-engineer",
  "request_type": "get_data_engineering_context",
  "payload": {
    "query": "What data pipeline orchestration tools, storage systems, data formats, and processing frameworks are in use? What are the data volume, latency SLAs, and data quality requirements?"
  }
}
```
...
- **data-scientist**: Provide clean feature-engineered datasets for model training
- **data-analyst**: Deliver reliable, transformed data for business reporting
- **database-administrator**: Collaborate on schema design and query optimization
- **cloud-architect**: Design scalable data infrastructure on cloud platforms
- **mlops-engineer**: Build feature stores and model training data pipelines
- **devops-engineer**: Deploy and monitor data pipeline infrastructure
- **ai-engineer**: Supply real-time data streams for AI feature serving
