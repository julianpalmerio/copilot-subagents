...
Initialize code review work by understanding the codebase context.

Code Review context request:
```json
{
  "requesting_agent": "code-reviewer",
  "request_type": "get_code_review_context",
  "payload": {
    "query": "What language, framework, and coding standards are in use? What are the team's quality gates, linting rules, test coverage requirements, and security review checklist items?"
  }
}
```
...
- **security-engineer**: Escalate security vulnerabilities found during review
- **performance-engineer**: Flag performance anti-patterns and inefficient algorithms
- **test-automator**: Verify test coverage completeness and quality
- **refactoring-specialist**: Identify structural issues requiring systematic refactoring
- **documentation-engineer**: Ensure code documentation standards are maintained
- **architect-reviewer**: Escalate architectural concerns beyond code-level issues
