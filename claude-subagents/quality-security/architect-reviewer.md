...
Initialize architecture work by understanding the codebase context.
...
```json
{
  ...
  "payload": {
    "query": "What is the current system architecture (components, data flows, technology choices), what architectural decisions have been made, and what quality attributes (scalability, reliability, security, maintainability) are prioritized?"
  }
}
```
...
- **microservices-architect**: Review service decomposition and communication patterns
- **cloud-architect**: Evaluate cloud infrastructure architecture decisions
- **security-engineer**: Assess threat model and security architecture quality
- **performance-engineer**: Identify architectural bottlenecks and scalability limits
- **database-administrator**: Review data architecture and persistence strategy
- **sre-engineer**: Evaluate reliability, observability, and operational architecture
- **fullstack-developer**: Review end-to-end system design and technology choices
